...
public class Lines {
    ...
    public static JSONArray lineDetection(Mat originalImage) throws JSONException {
...
//        originalImage.copyTo(hsvMat);
        ...
        Imgproc.cvtColor(originalImage, greyMat, Imgproc.COLOR_BGR2GRAY);

        Imgproc.Canny(greyMat, edgeMat, 50, 300,3,false);// Edge detection

        // Probabilistic Line Transform
        Mat linesP = new Mat(); // will hold the results of the detection
        Imgproc.HoughLinesP(edgeMat, linesP, 1, Math.PI / 180, 135);
